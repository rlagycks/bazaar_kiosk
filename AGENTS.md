...
### PR 제출 시 독립 리뷰 (2026-09-22 사용자 지시)

- 모든 PR 제출 전에 서브에이전트에게 대상 diff의 독립 리뷰를 요청합니다.
- 지적의 재현 가능성·의도를 검토하고 필요한 수정과 검증을 완료합니다. 수정한 부분은 다시 리뷰합니다.
- PR 본문에 검토한 기준/범위, 리뷰 결과·반영 사항, 검사 결과와 미실행 항목을 기록합니다.
- 이미 열린 PR의 후속 변경도 변경 범위에 맞춰 리뷰합니다. 리뷰 통과를 merge·배포 승인으로 보지 않습니다.
