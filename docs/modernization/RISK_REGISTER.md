...
| 2 | [BK-R020 — Realtime 연결 상실 후 폴링 복귀·재동기화 부재](ANALYSIS_REPORT.md#bk-r020) | High | Code-supported | 성격 변경·악화 (4B2, D-056: 폴링 제거로 SSE까지 자동 갱신 없음. **앞에 떠 있는 탭은 권한 회수도 감지하지 못한다**. 10D 선행 필수) | D-010,D-007; 단계 4B,8,9 | 실시간 담당 | 10 | SUBSCRIBED이후 CLOSED/ERROR/TIMEOUT, duplicate/out-of-order/drop, 느린응답·재접속 |
