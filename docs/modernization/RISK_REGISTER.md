...
| 3 | [BK-R015 — JSON 입력 타입·테이블 분기 불일치가 500으로 노출](ANALYSIS_REPORT.md#bk-r015) | Medium | Reproduced | 해소 (9: 적대적 입력 500 36건 -> 0건) | D-014,D-008; 단계 6,7 | API 담당 | 9 | 누락/null/list/dict/정수/문자열/UTF8/메서드별 오류 계약 |
