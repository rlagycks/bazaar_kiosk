...
| 2 | [BK-R028 — DEBUG 오류 페이지가 환경에서 설정한 역할 PIN도 노출](ANALYSIS_REPORT.md#bk-r028) | High | Repo-fixed (오류 보고 경로만) | Open (4A1/운영 인수 대기) | D-002,D-006; 단계 3 | 보안·운영 담당 | 4A | 합성 자격증명으로500 HTML/JSON·로그에 값이 없는지, **env누락 실패(미구현)** |
