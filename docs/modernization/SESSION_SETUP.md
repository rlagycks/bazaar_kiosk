...
- **이 문서 기준 시점(2026-09-11)에4A1까지 머지됐고 단계3 준비를 진행 중이다.**
  BK-R001(유일한 Critical)의 권한 현황 전수 측정을 마쳤다. [측정과 D-003 결정표](AUTHORIZATION_MATRIX.md).
  인가를 강제하는 구현은 D-003 확정과 별도 승인 이후다. 측정만으로 위험은 종료되지 않는다.
