...
독립8A는 집계500 수정·로컬 PG 검증 완료이며2B 이후 최종 인수 대기입니다.
...
진행할 수 있습니다.8A는 로컬 PG에서도 검증됐지만2B 이후 최종 인수 관문은 유지하세요.
...
BLUEPRINT와 SESSION_SETUP의 PostgreSQL 격리 검증 프로필을 사용하세요. 사용자 지시로
SQLite 지원을 제거하는 후속 PR44가 진행 중입니다. settings_test_pg는 별도 BK_TEST_DATABASE_URL과
