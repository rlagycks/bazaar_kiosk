...
urlpatterns = [
    ...
    # 10D1: the kitchen's event stream. Under the same non-buffering proxy
    # location as the probe, which a runtime test checks.
    path("api/stream/kitchen",      stream.kitchen_stream,          name="kitchen-stream"),
    path("api/stream/probe",        stream_probe.stream_probe,      name="stream-probe"),
]
